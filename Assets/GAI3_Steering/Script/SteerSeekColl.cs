...
untuk mengakses gunakan transform
    ...
    {
       Vector3 ahead = this.transform.position + _velocity.normalized * _max_See_Ahead * 0.5f;
   ...
   public Circle findMostThreateningObstacle()  {
	   //lengkapi titik2
    Vector3 ahead = transform.position + _velocity.normalized * _max_See_Ahead;
    Vector3 ahead2 = transform.position + _velocity.normalized * _max_See_Ahead * 0.5f;
